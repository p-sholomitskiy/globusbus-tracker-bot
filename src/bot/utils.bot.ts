...
export const createConfirmDataMessage = (ctx: BotCustomContext) => {
	const { enteredStartLocation, enteredEndLocation, enteredDate, enteredTrackInterval } = ctx.session;
...
export const botTextMessage = async (ctx: BotCustomContext, textMessage: string, keyboard?: InlineKeyboard) => {
